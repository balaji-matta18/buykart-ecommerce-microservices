# BuyKart: An E-commerce Microservices Application

## Solution Overview

BuyKart is a robust e-commerce application built on a microservices architecture using Spring technologies and other open-source tools. 
...
With a focus on scalability, resilience, and real-time interaction, BuyKart provides a robust foundation for creating feature-rich online marketplaces.
...
- **Message Broker:** Apache Kafka forms the backbone of BuyKart's event-driven architecture, facilitating asynchronous notification for orders.
...
- **Setup Postman Authentication** [Required in the next steps]
  - On the Request page, set Authorization:
    ...
    - Configure New Token with:
      ...
      - Access Token URL: `http://keycloak:8080/realms/spring-boot-microservices-realm-realm/protocol/openid-connect/token`
